...
public class MissingReference extends MediaReference {
    ...
    public static class MissingReferenceBuilder {
        ...
        public MissingReferenceBuilder setName(String name) {
            this.name = name;
            return this;
        }

        public MissingReferenceBuilder setAvailableRange(TimeRange availableRange) {
            this.availableRange = availableRange;
            return this;
        }


        public MissingReferenceBuilder setMetadata(AnyDictionary metadata) {
