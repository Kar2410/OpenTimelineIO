...
public class TimeEffect extends Effect {
    ...
    public TimeEffect(TimeEffectBuilder builder) {
    ...
    public static class TimeEffectBuilder {
        ...
        public TimeEffectBuilder setName(String name) {
            this.name = name;
            return this;
        }

        public TimeEffectBuilder setEffectName(String effectName) {
            this.effectName = effectName;
            return this;
        }

        public TimeEffectBuilder setMetadata(AnyDictionary metadata) {
