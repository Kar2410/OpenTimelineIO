...
public class GeneratorReference extends MediaReference {
    ...
    public static class GeneratorReferenceBuilder {
        ...
        public GeneratorReferenceBuilder setName(String name) {
            this.name = name;
            return this;
        }

        public GeneratorReferenceBuilder setGeneratorKind(String generatorKind) {
            this.generatorKind = generatorKind;
            return this;
        }

        public GeneratorReferenceBuilder setAvailableRange(TimeRange availableRange) {
            this.availableRange = availableRange;
            return this;
        }

        public GeneratorReferenceBuilder setParameters(AnyDictionary parameters) {
            this.parameters = parameters;
            return this;
        }

        public GeneratorReferenceBuilder setMetadata(AnyDictionary metadata) {
