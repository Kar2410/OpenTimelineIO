...
public class ImageSequenceReference extends MediaReference {
    ...
    public static class ImageSequenceReferenceBuilder {
        ...
        public ImageSequenceReferenceBuilder setTargetURLBase(String targetURLBase) {
            this.targetURLBase = targetURLBase;
            return this;
        }

        public ImageSequenceReferenceBuilder setNamePrefix(String namePrefix) {
            this.namePrefix = namePrefix;
            return this;
        }

        public ImageSequenceReferenceBuilder setNameSuffix(String nameSuffix) {
            this.nameSuffix = nameSuffix;
            return this;
        }

        public ImageSequenceReferenceBuilder setStartFrame(int startFrame) {
            this.startFrame = startFrame;
            return this;
        }

        public ImageSequenceReferenceBuilder setFrameStep(int frameStep) {
            this.frameStep = frameStep;
            return this;
        }

        public ImageSequenceReferenceBuilder setRate(double rate) {
            this.rate = rate;
            return this;
        }

        public ImageSequenceReferenceBuilder setFrameZeroPadding(int frameZeroPadding) {
        ...
        public ImageSequenceReferenceBuilder setAvailableRange(TimeRange availableRange) {
            this.availableRange = availableRange;
            return this;
        }


        public ImageSequenceReferenceBuilder setMetadata(AnyDictionary metadata) {
