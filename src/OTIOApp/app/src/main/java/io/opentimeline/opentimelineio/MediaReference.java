...
public class MediaReference extends SerializableObjectWithMetadata {
    ...
    public static class MediaReferenceBuilder {
        ...
        public MediaReferenceBuilder setName(String name) {
            this.name = name;
            return this;
        }

        public MediaReferenceBuilder setAvailableRange(TimeRange availableRange) {
            this.availableRange = availableRange;
            return this;
        }


        public MediaReferenceBuilder setMetadata(AnyDictionary metadata) {
