...
public class UnknownSchema extends SerializableObject {
    ...
    public static class UnknownSchemaBuilder {
        ...
        public UnknownSchemaBuilder setOriginalSchemaName(String originalSchemaName) {
            this.originalSchemaName = originalSchemaName;
            return this;
        }

        public UnknownSchemaBuilder setOriginalSchemaVersion(int originalSchemaVersion) {
