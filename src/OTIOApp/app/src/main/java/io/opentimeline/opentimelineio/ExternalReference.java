...
public class ExternalReference extends MediaReference {
    ...
    public ExternalReference(ExternalReferenceBuilder mediaReferenceBuilder) {
        this.initObject(
    ...
    public static class ExternalReferenceBuilder {
        ...
        public ExternalReferenceBuilder setTargetURL(String targetURL) {
            this.targetURL = targetURL;
            return this;
        }

        public ExternalReferenceBuilder setAvailableRange(TimeRange availableRange) {
            this.availableRange = availableRange;
            return this;
        }


        public ExternalReferenceBuilder setMetadata(AnyDictionary metadata) {
