...
public class Transition extends Composable {
    ...
    public static class TransitionBuilder {
        ...
        public TransitionBuilder setTransitionType(String transitionType) {
            this.transitionType = transitionType;
            return this;
        }

        public TransitionBuilder setInOffset(RationalTime inOffset) {
            this.inOffset = inOffset;
            return this;
        }

        public TransitionBuilder setOutOffset(RationalTime outOffset) {
            this.outOffset = outOffset;
            return this;
        }

        public TransitionBuilder setMetadata(AnyDictionary metadata) {
