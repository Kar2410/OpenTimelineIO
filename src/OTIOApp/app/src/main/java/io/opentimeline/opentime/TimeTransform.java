...
//        if (!LibraryLoader.load(OTIOObject.class, "jotio"))
    ...
    public static class TimeTransformBuilder {
        ...
        public TimeTransformBuilder setOffset(RationalTime offset) {
            this.offset = offset;
            return this;
        }

        public TimeTransformBuilder setScale(double scale) {
            this.scale = scale;
            return this;
        }

        public TimeTransformBuilder setRate(double rate) {
            this.rate = rate;
            return this;
        }
