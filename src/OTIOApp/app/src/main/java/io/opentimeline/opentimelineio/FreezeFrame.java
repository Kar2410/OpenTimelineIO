...
public class FreezeFrame extends LinearTimeWarp {
    ...
    public FreezeFrame(FreezeFrameBuilder builder) {
    ...
    public static class FreezeFrameBuilder {
        ...
        public FreezeFrameBuilder setName(String name) {
            this.name = name;
            return this;
        }

        public FreezeFrameBuilder setMetadata(AnyDictionary metadata) {
