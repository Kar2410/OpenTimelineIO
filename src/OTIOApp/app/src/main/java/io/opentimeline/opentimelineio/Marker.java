...
public class Marker extends SerializableObjectWithMetadata {
    ...
    public static class MarkerBuilder {
        ...
        public MarkerBuilder setMarkedRange(TimeRange markedRange) {
            this.markedRange = markedRange;
            return this;
        }

        public MarkerBuilder setColor(String color) {
            this.color = color;
            return this;
        }

        public MarkerBuilder setMetadata(AnyDictionary metadata) {
