...
public class Gap extends Item {
    ...
    public static class GapBuilder {
        ...
        public GapBuilder setName(String name) {
            this.name = name;
            return this;
        }

        public GapBuilder setSourceRange(TimeRange sourceRange) {
            this.sourceRange = sourceRange;
            this.duration = null;
            return this;
        }

        public GapBuilder setDuration(RationalTime duration) {
            this.duration = duration;
            this.sourceRange = null;
            return this;
        }

        public GapBuilder setMetadata(AnyDictionary metadata) {
            this.metadata = metadata;
            return this;
        }

        public GapBuilder setEffects(List<Effect> effects) {
            this.effects = effects;
            return this;
        }

        public GapBuilder setMarkers(List<Marker> markers) {
