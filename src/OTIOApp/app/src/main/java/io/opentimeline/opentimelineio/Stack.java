...
public class Stack extends Composition {
    ...
    public static class StackBuilder {
        ...
        public StackBuilder setSourceRange(TimeRange sourceRange) {
            this.sourceRange = sourceRange;
            return this;
        }

        public StackBuilder setMetadata(AnyDictionary metadata) {
            this.metadata = metadata;
            return this;
        }

        public StackBuilder setEffects(List<Effect> effects) {
            this.effects = effects;
            return this;
        }

        public StackBuilder setMarkers(List<Marker> markers) {
