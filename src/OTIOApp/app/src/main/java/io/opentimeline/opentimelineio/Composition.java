...
public class Composition extends Item {
    ...
    public static class CompositionBuilder {
        ...
        public CompositionBuilder setSourceRange(TimeRange sourceRange) {
            this.sourceRange = sourceRange;
            return this;
        }

        public CompositionBuilder setMetadata(AnyDictionary metadata) {
            this.metadata = metadata;
            return this;
        }

        public CompositionBuilder setEffects(List<Effect> effects) {
            this.effects = effects;
            return this;
        }

        public CompositionBuilder setMarkers(List<Marker> markers) {
